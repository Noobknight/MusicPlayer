...
public class CoverLoader {
    ...
    public Bitmap loadThumbnail(String uri) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(MusicPlayerApplication.getInstance().getResources(),
            ...
            if (bitmap == null) {
                bitmap = loadBitmap(uri, ScreenUtils.getScreenWidth() / 1);
                if (bitmap == null) {
    ...
    public Bitmap loadBlur(String uri) {
        ...
        if (TextUtils.isEmpty(uri)) {
            ...
            if (bitmap == null) {
                bitmap = BitmapFactory.decodeResource(MusicPlayerApplication.getInstance().getResources(),
                        R.drawable.ic_play_page_default_bg);
