 ...
 */
public class MusicVietNam extends BaseModel implements Parcelable{
    private static final String TAG = "MusicVietNam";

    public MusicVietNam() {
    }

    public MusicVietNam(String music_id, String music_title, String music_artist, String music_title_url,
    ...
    protected MusicVietNam(Parcel in) {
    ...
    public static final Creator<MusicVietNam> CREATOR = new Creator<MusicVietNam>() {
        @Override
        public MusicVietNam createFromParcel(Parcel source) {
            return new MusicVietNam(source);
        }

        @Override
        public MusicVietNam[] newArray(int size) {
            return new MusicVietNam[size];
        }
    };
