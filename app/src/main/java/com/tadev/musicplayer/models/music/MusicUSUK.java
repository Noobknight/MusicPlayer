 ...
 */
public class MusicUSUK extends BaseModel implements Parcelable {
    private static final String TAG = "MusicUSUK";
    public MusicUSUK() {
    }

    public MusicUSUK(String music_id, String music_title, String music_artist, String music_title_url,
    ...
    public static final Creator<MusicUSUK> CREATOR = new Creator<MusicUSUK>() {
        @Override
        public MusicUSUK createFromParcel(Parcel source) {
            return new MusicUSUK(source);
        }

        @Override
        public MusicUSUK[] newArray(int size) {
            return new MusicUSUK[size];
        }
    };
