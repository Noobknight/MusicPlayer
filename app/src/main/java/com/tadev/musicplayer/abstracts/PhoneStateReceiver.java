...
public abstract class PhoneStateReceiver extends BroadcastReceiver {
    ...
    private static final String OUT_GOING_CALL = "android.intent.action.NEW_OUTGOING_CALL";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction().equals(OUT_GOING_CALL)) {
    ...
    protected abstract void onIncomingAnswered(Context context, String number, Date start);

    protected abstract void onIncomingCallEnd(Context context, String number, Date start, Date end);
        ...
        switch (state) {
            ...
            case TelephonyManager.CALL_STATE_OFFHOOK:
                ...
                if (lastState != TelephonyManager.CALL_STATE_RINGING) {
                    ...
                    isIncoming = true;
                    callStartTime = new Date();
                    onIncomingAnswered(context, savedNumber, callStartTime);
                }
                break;
            case TelephonyManager.CALL_STATE_IDLE:
                ...
                if (state == TelephonyManager.CALL_STATE_RINGING) {
                    ...
                    onIncomingCallEnd(context, savedNumber, callStartTime, new Date());
                } else {
